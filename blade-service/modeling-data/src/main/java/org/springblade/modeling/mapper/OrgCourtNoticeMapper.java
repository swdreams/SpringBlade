 ...
 * @since 2020-12-16
 */
public interface OrgCourtNoticeMapper extends BaseMapper<OrgCourtNotice> {
	 ...
	 * @return
	 */
	List<OrgCourtNoticeVO> selectOrgCourtNoticePage(IPage page, OrgCourtNoticeVO orgCourtNotice);
